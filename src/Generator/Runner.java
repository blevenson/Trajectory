...
import Test.TrajectoryMapper;

import IO.TextFileSerializer;


public class Runner {
	public static ArrayList<TrajectoryMapper.Point> points = new ArrayList<TrajectoryMapper.Point>();
  ...
  public static void main(String[] args) {
    ...
    
    {
     ...
     //Test
     {
         ...
         config.max_vel = 12.0;
         // Path name must be a valid Java class name.
         final String path_name = "LoopyPath";
         
         // Description of this auto mode path.
         // Remember that this is for the GO LEFT CASE!
         WaypointSequence p = new WaypointSequence(10);
         p.addWaypoint(new WaypointSequence.Waypoint(0, 0, 0));
         p.addWaypoint(new WaypointSequence.Waypoint(7.0, 7.0, 0));
         p.addWaypoint(new WaypointSequence.Waypoint(15.0, -7.0, Math.PI / 12.0));
     ...
     //Test from program
     {
         ...
         config.max_vel = 12.0;
         // Path name must be a valid Java class name.
         final String path_name = name;
         
         // Description of this auto mode path.
         // Remember that this is for the GO LEFT CASE!
         WaypointSequence p = new WaypointSequence(10);
         for(TrajectoryMapper.Point i : points){
        	 p.addWaypoint(new WaypointSequence.Waypoint(i.getX(), i.getY(), Math.PI / 12.0));
         }
         p.addWaypoint(new WaypointSequence.Waypoint(15.0, -7.0, Math.PI / 12.0));
